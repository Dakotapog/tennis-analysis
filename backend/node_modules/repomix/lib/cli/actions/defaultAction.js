 ...
 */
export const handleStdinProcessing = (directories, cwd, config, cliOptions) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
 ...
 */
export const handleDirectoryProcessing = (directories, cwd, config, cliOptions) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const printResults = (cwd, packResult, config) => {
    logger.log('');
    if (config.output.topFilesLength > 0) {
        printTopFiles(packResult.fileCharCounts, packResult.fileTokenCounts, config.output.topFilesLength, packResult.totalTokens);
        logger.log('');
    }
