...
> Last updated: 2026-07-21 (Nodo-127: IDs outcome genéricos ITF + filtro STARTED — D126-04/D126-05 documentados, pendientes implementación. 2207 tests.)
...
**Nodo-127 (GamesSignal ITF OutcomeID Fix):** D126-04: sin filtro partidos STARTED → odds live @9.5 distorsionan combo. Fix: `state=="NOT_STARTED"` en `_buscar_event_id_kambi()`. D126-05: IDs outcome genéricos en ITF — ID `4265916952` aparece en 30+ partidos distintos, Betplay carga partido aleatorio. Fix: `_es_outcome_unico()` descarta IDs compartidos. Impacto: GAMES combos confiables solo en ATP250+. Tests: 3 REGLA-T53 pendientes. Estado: PENDIENTE.
