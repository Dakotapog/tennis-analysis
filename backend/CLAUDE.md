...
> Last updated: 2026-07-22 (Nodo-139: Kambi-First Combo Builder D139-01→D139-07 — 15 tests. --kambi-first flag. Sin cap cuota (EV gate). H139-01/02 pre-registradas. 2278 tests.)
...
| Métrica | Valor |
|---|---|
| Tests | **2278 passed, 1 failed** (verificado 2026-07-22). `test_nodo51_f3_02_budget_processes_itf_before_grand_slam` pre-existente. +15 tests Nodo-139 (`test_nodo139_kambi_first.py`). |
...
**Nodos completos:** 51-63, 64-71, 72, 73, 78, 86-113, 117-123, 126-129, 133, 135-139 — detalles en `.spec/01_Nodos/Nodo-XX.md`
