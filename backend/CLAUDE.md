...
> Last updated: 2026-07-28 (Nodo-150: Live Games Risk Intelligence — 5 gaps post-simulación doctoral 2026-07-28. D150-01: CUOTA_ENVENENADA filter en _check_games_convergencia (umbral +15%, campo cuota_envenenada en señal ITF). D150-02: games_set1 en _parse_kambi_livedata_sets + propagación via _enrich_live_score. D150-03: zona=COINFLIP_FORZADO en call sites de _calcular_certeza_condicional cuando set1 tiebreak ≥12j. D150-04: parámetro games_set1 en _calcular_certeza_condicional — override interno DOMINANTE→COINFLIP. D150-05: badges MERCADO CONFIRMA (verde, drift<-15%) y CUOTA ENVENENADA (rojo) en render X3. D150-06: SET1_SCORE_GATE + CUOTA_ENVENENADA gate antes de _fire_itf_live_games_combo. H150-01/H150-02 pre-registradas. 10 tests REGLA-T53. 2353 tests.)
...
**Nodos completos:** 51-63, 64-71, 72, 73, 78, 86-113, 117-123, 126-129, 133, 135-141, 143-150 — detalles en `.spec/01_Nodos/Nodo-XX.md`
