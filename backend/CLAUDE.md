...
> Last updated: 2026-07-22 (Nodo-138: G2 multi-signal gate D138-01+D138-02 — 9 tests. Nodo-137: governor MOTOR exclusion + rival_value subprocess fix. Nodo-136: tier CTI fallback D136-01. 2263 tests.)
...
| Métrica | Valor |
|---|---|
| Tests | **2263 passed, 1 failed** (verificado 2026-07-22). `test_nodo51_f3_02_budget_processes_itf_before_grand_slam` pre-existente. +9 tests Nodo-138 (`test_nodo138_g2_evolution.py`). |
...
**Nodos completos:** 51-63, 64-71, 72, 73, 78, 86-113, 117-123, 126-129, 133, 135-138 — detalles en `.spec/01_Nodos/Nodo-XX.md`
