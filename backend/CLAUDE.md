...
> Last updated: 2026-07-22 (Nodo-141: Kambi-Only Edge Report — PASO 3K + filter_kambi_picks.py + _find_latest prefer kambi HOY. 8 tests. 2295 tests.)
...
| Métrica | Valor |
|---|---|
| Tests | **2295 passed, 1 failed** (verificado 2026-07-22). `test_nodo51_f3_02_budget_processes_itf_before_grand_slam` pre-existente. +8 tests Nodo-141 (`test_nodo141_kambi_only_report.py`). |
...
**Nodos completos:** 51-63, 64-71, 72, 73, 78, 86-113, 117-123, 126-129, 133, 135-141 — detalles en `.spec/01_Nodos/Nodo-XX.md`
