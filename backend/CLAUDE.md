...
> Last updated: 2026-07-22 (Nodo-140: Kambi Gate D140-01→D140-04 — 9 tests. PASO 1c coverage fresca. Pre-filtro kambi_disponible en safe/was/mega/CORE/SAT/MOON. 2287 tests.)
...
| Métrica | Valor |
|---|---|
| Tests | **2287 passed, 1 failed** (verificado 2026-07-22). `test_nodo51_f3_02_budget_processes_itf_before_grand_slam` pre-existente. +9 tests Nodo-140 (`test_nodo140_kambi_gate.py`). |
...
**Nodos completos:** 51-63, 64-71, 72, 73, 78, 86-113, 117-123, 126-129, 133, 135-140 — detalles en `.spec/01_Nodos/Nodo-XX.md`
