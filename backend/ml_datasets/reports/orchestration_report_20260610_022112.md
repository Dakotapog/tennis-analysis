# 🚀 ML Dataset Orchestration Report
**Generado:** 2026-06-10 02:21:12
...
- **Dataset Original:** (386, 35)
- **Dataset Enhanced:** (386, 35)
...
- **Regression_P1_Prob_Win:** ✅ R²: 0.998

---

Reporte del enhancer no disponible.
## 🔮 Recomendaciones de Optimización
- 📊 **Ampliación:** Dataset pequeño - considerar técnicas de data augmentation

## ⚙️ Especificaciones Técnicas

### Configuración del Pipeline
- **Threshold de Accuracy:** 0.65
- **Correlación Máxima:** 0.95
- **Mínimo de Muestras:** 100
- **Formatos de Exportación:** csv, parquet, json, csv, parquet, numpy, csv, h5, tfrecord_ready
